    ...
    return (
        ...
        <div className="flex justify-center items-center h-screen">
            <form className="bg-slate-900 w-1/2 flex flex-col items-center h-96" action="">
                <h1 className="text-white text-6xl font-light pt-16">Welcome Back</h1>
                <p className="text-slate-300">Please sign into your account</p>
                {/* email */}
                <div>
                    <label className="text-slate-300" htmlFor="email">your email here</label>
                    <input className="text-slate-300" type="text" placeholder='email here' />
                </div>
                {/* password */}
                <div>
